...
var _quoteVueJs = require("./vue/quoteVue.js");
var _quoteVueJsDefault = parcelHelpers.interopDefault(_quoteVueJs);
const getQuoteController = async function() {
    try {
        (0, _quoteVueJsDefault.default).loader();
        await _modelJs.getQuote();
        const quote = _modelJs.randomChoosedQuote(_modelJs.state.quotes);
        (0, _quoteVueJsDefault.default).render(quote);
    } catch (error) {
        console.log(error);
    }
};
const init = function() {
    (0, _quoteVueJsDefault.default).addLoadHandler(getQuoteController);
    (0, _quoteVueJsDefault.default).addClickHandler(getQuoteController);
};
init();

},{"core-js/modules/esnext.symbol.dispose.js":"b9ez5","core-js/modules/web.immediate.js":"49tUX","./models/model.js":"3wLgc","regenerator-runtime":"dXNgZ","./vue/quoteVue.js":"j8q9h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b9ez5":[function(require,module,exports) {
"use strict";
...
parcelHelpers.export(exports, "randomChoosedQuote", ()=>randomChoosedQuote);
...
const randomChoosedQuote = function(arr) {
    try {
        const number = (0, _helpersJs.randomNumberGeneratro)(0, arr.length);
...
},{"./../config/config.js":"cIbW6","./../helpers/helpers.js":"75M5l","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cIbW6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "randomNumberGeneratro", ()=>randomNumberGeneratro);
const getJSON = async function(url) {
    try {
        const response = await fetch(url);
        const data = await response.json();
        if (!response.ok) throw new Error(`Sorry we some problem with fetching quote`);
        return data;
    } catch (error) {
        throw error;
    }
};
const randomNumberGeneratro = function(min = 0, max) {
...
},{}],"j8q9h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class QuoteVue {
...
exports.default = new QuoteVue();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kYpTN","aenu9"], "aenu9", "parcelRequire5abf")
